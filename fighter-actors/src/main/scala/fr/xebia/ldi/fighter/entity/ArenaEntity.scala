...
case object ArenaEntity {
  ...
  case object `6E-ARR` extends ArenaEntity(0, "ARENA PARIS 6", "PRO", 30, "PARIS, 6EM ARRONDISSEMENT")
  case object `9E-ARR` extends ArenaEntity(1, "ARENA PARIS 9", "FAMILY", 21, "PARIS, 9EM ARRONDISSEMENT")
  case object `15E-ARR` extends ArenaEntity(2, "ARENA PARIS 15", "FUN", 15, "PARIS, 15EM ARRONDISSEMENT")
  case object `16E-ARR` extends ArenaEntity(3, "ARENA PARIS 16", "FUN", 18, "PARIS, 16EM ARRONDISSEMENT")
