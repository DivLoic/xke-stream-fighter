...
case object CharacterEntity {
  ...
  // street fighter
  case object KEN extends CharacterEntity("Ken", StreetFighter, "US", "", "2")
  case object RYU extends CharacterEntity("Ryu", StreetFighter, "Japan", "", "6")
  case object GEKI extends CharacterEntity("Geki", StreetFighter, "Japan", "", "6")
  case object CHUNLI extends CharacterEntity("Chun-Li", StreetFighter, "China", "", "3")
  case object AKUMA extends CharacterEntity("Akuma", StreetFighter, "Japan", "", "7")
  case object SAKURA extends CharacterEntity("Sakura", StreetFighter, "Japan", "", "6")
  case object DHALSIM extends CharacterEntity("Dhalsim", StreetFighter, "India", "", "2")
  case object BLAIR extends CharacterEntity("Blair", StreetFighter, "UK", "", "2")
  ...
  // soul calibur
  case object KILIK extends CharacterEntity("Kilik", SoulCalibur, "", "", "")
  case object IVY extends CharacterEntity("Ivy", SoulCalibur, "", "", "")
  case object SIEGFRIED extends CharacterEntity("Siegfried", SoulCalibur, "", "", "")
